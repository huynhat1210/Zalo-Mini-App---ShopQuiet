...
const SavedItems = lazy(() =>
  import("./pages/saved-items").then((module) => ({
    default: module.SavedItems,
  })),
);
...
const OrderDetail = lazy(() =>
  import("./pages/order-detail").then((module) => ({
    default: module.OrderDetail,
  })),
);
const PaymentSimulate = lazy(() =>
  import("./pages/payment-simulate").then((module) => ({
    default: module.PaymentSimulate,
  })),
);
const FlashSaleList = lazy(() =>
  import("./pages/flash-sale-list").then((module) => ({
    default: module.FlashSaleList,
  })),
);
...
export default function App() {
  ...
  const selectedProductDetail = useAppStore(
  ...
  const setSelectedProductDetail = useAppStore(
  ...
  const setChatContextProduct = useAppStore(
    (state) => state.setChatContextProduct,
  );
  ...
  const fetchGamificationData = useAppStore(
    (state) => state.fetchGamificationData,
  );
  ...
  const handleRetryConnection = () => {
    ...
    if (online) {
      ...
      showToast(
        "Vẫn chưa có kết nối internet. Vui lòng kiểm tra lại.",
        "warning",
      );
    }
  };
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 flex flex-col relative overflow-hidden">
                      <Suspense
                        fallback={
                          <div className="flex items-center justify-center h-full text-textColor-variant text-xs">
                            Đang tải...
                          </div>
                        }
                      >
                        ...
                        {activeTab === "orders" && (
                          <Profile initialSubPage="orders" />
                        )}
                        {activeTab === "notifications" && <Notifications />}
                        {activeTab === "profile" && <Profile />}
                        {activeTab === "ranking" && (
                          <Profile initialSubPage="ranking" />
                        )}
