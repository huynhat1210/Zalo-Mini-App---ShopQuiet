    ...
    <div className="fixed inset-0 z-[100] bg-black/45 backdrop-blur-xs flex items-center justify-center p-6 animate-fade-in">
      <div className="bg-white w-full max-w-sm rounded-3xl p-6 border border-[#f0edeb] shadow-2xl space-y-4 animate-scale-up">
        <div className="flex justify-between items-center pb-1">
          ...
          <button onClick={onClose} className="p-1 text-slate-400 hover:text-slate-600 border-none bg-transparent cursor-pointer text-base leading-none font-bold">×</button>
        </div>
        ...
        {!showAddForm ? (
          ...
          <div className="border border-neutral-100 bg-neutral-50/50 p-4 rounded-2xl space-y-3 mt-2 animate-fade-in text-left">
            ...
            <div>
              <label className="text-[9px] font-bold text-textColor-variant uppercase tracking-wider block mb-1">Tên nhãn</label>
              <input
                type="text"
                {...register('label')}
            ...
            <div>
              <label className="text-[9px] font-bold text-textColor-variant uppercase tracking-wider block mb-1">Địa chỉ chi tiết</label>
              <input
                type="text"
                {...register('street')}
            ...
            <div>
              <label className="text-[9px] font-bold text-textColor-variant uppercase tracking-wider block mb-1">Tỉnh / Thành phố</label>
              <input
                type="text"
                {...register('city')}
