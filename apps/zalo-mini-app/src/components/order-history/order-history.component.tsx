...
export const OrderHistory: React.FC<IOrderHistoryProps> = (props) => {
  ...
  return (
    <PageCast className="bg-[#f7f7f7]  text-slate-900  relative flex flex-col w-full h-full overscroll-none scrollbar-none">
      {/* Header */}
      <div className="bg-white  px-6 py-4 flex items-center justify-between border-b border-[#f0edeb]  sticky top-0 z-30 shadow-xs">
        <button
          ...
          className="p-1.5 -ml-1.5 hover:bg-[#f0edeb] :bg-slate-800 rounded-full transition-colors border-none bg-transparent cursor-pointer"
        >
              ...
              >
                        ...
                        : order.status === "SHIPPED"
                          ...
                          : order.status === "CANCELLED"
                            ...
                            : order.status === "PENDING_PAYMENT"
                              ? "bg-orange-50 /40 text-orange-600 "
                ...
                {order.status === "PENDING_PAYMENT" ? (
                  <div className="pt-3 border-t border-[#f0edeb]  space-y-2.5">
                    <div className="bg-orange-50 /40 border border-orange-200 /60 rounded-xl p-3 flex items-start gap-2.5">
                      <span className="text-orange-500 text-lg mt-0.5">•</span>
                      <div className="text-xs">
                        <p className="font-bold text-orange-700 ">
                          Chờ thanh toán ({order.paymentMethod === "COD" ? "Thanh toán khi nhận hàng" : "Chuyển khoản Ngân hàng"})
                        </p>
                        <p className="text-orange-600/80 /80 text-[10px] mt-0.5 leading-relaxed">
                  ...
                  <div className="flex-1 flex flex-col justify-between py-0.5">
                    ...
                    <div className="flex justify-between items-end mt-2">
                      <div className="flex gap-1.5">
                        <span className="text-[8px] font-bold text-primary  bg-primary-light /50 px-2 py-0.5 rounded-md">
                          Freeship
                        </span>
                        <span className="text-[8px] font-bold text-amber-700  bg-amber-50 /50 px-2 py-0.5 rounded-md">
                          Giảm 10%
                        </span>
                      </div>
