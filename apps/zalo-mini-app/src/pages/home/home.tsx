...
export const Home: React.FC<IHomeProps> = (_props) => {
  ...
  useEffect(() => {
    ...
    async function loadSettings() {
      try {
        const settings =
          await apiRequest<Record<string, string>>("/cms/settings");
  ...
  return (
    <PageCast
      ...
      className="bg-surface relative flex flex-col w-full h-full overscroll-none scrollbar-none animate-fade-in"
    >
      {/* Top Header App Bar */}
      <div className="bg-white/95 backdrop-blur-md px-6 py-4 flex items-center justify-between border-b border-[#f0edeb] sticky top-0 z-30 shadow-xs">
        <button
          ...
          className="p-2 -ml-2 hover:bg-neutral-100 rounded-full transition-colors active:scale-95 border-none bg-transparent cursor-pointer"
        >
      ...
      <div className="flex-1 overflow-y-auto pb-28">
                ...
                >
                  ...
                  <div className="relative z-20 px-6 flex flex-col justify-center h-full max-w-[270px] text-white">
                    ...
                    <button
                      ...
                      onClick={() =>
                        slide.category && setSelectedCategory(slide.category)
                      }
                    >
                      {slide.cta}
                    </button>
        ...
        <BoxCast className="my-6">
          ...
          <div
            ref={lastElementRef}
            className="w-full h-12 mt-4 flex items-center justify-center"
          >
