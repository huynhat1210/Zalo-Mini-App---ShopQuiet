  ...
  const handleGetLocation = async () => {
    ...
    const processCoords = async (lat: number, lng: number) => {
      try {
        ...
        console.error(err);
        showToast("Không thể tự động đọc vị trí từ GPS. Vui lòng chọn Tỉnh/Thành thủ công.", "warning");
      } finally {
    ...
    if (navigator.geolocation) {
            ...
            apiAny.getLocation({
              success: (data: any) => {
                ...
                if (lat != null && lng != null) {
                  ...
                  showToast("Không nhận được tọa độ từ GPS.", "warning");
                  setIsLoadingLocation(false);
                }
              },
              fail: () => {
                showToast("GPS chưa được bật trên thiết bị.", "warning");
                setIsLoadingLocation(false);
              },
            });
          } else {
            showToast("Thiết bị từ chối quyền truy cập vị trí.", "warning");
            setIsLoadingLocation(false);
          }
        },
      ...
      apiAny.getLocation({
        ...
        fail: () => {
          showToast("Vui lòng cho phép truy cập vị trí khi được hỏi.", "warning");
          setIsLoadingLocation(false);
        },
      });
    } else {
