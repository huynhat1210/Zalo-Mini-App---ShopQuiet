...
async function main() {
  ...
  const PRODUCT_TEMPLATES = [
    { name: 'Áo thun Classic', categoryId: 1, basePrice: 20 * 25000 },
    { name: 'Quần Jean Denim', categoryId: 1, basePrice: 50 * 25000 },
    { name: 'Thắt lưng da', categoryId: 2, basePrice: 25 * 25000 },
    { name: 'Giày thể thao chạy bộ', categoryId: 3, basePrice: 80 * 25000 },
    { name: 'Cốc sứ cao cấp', categoryId: 4, basePrice: 15 * 25000 },
    { name: 'Áo Hoodie Cotton', categoryId: 1, basePrice: 40 * 25000 },
    { name: 'Kính râm thời trang', categoryId: 2, basePrice: 30 * 25000 },
    { name: 'Giày tây Oxford', categoryId: 3, basePrice: 120 * 25000 },
    { name: 'Gối tựa lưng', categoryId: 4, basePrice: 22 * 25000 },
    { name: 'Váy đầm mùa hè', categoryId: 1, basePrice: 45 * 25000 },
  ];
  ...
  for (let i = 1; i <= 30; i++) {
    ...
    const price = template.basePrice + Math.floor(Math.random() * 20) * 25000;
  ...
  const order1 = await prisma.order.create({
    data: {
      id: 'SQ-82955',
      totalAmount: 58.50 * 25000,
      status: 'SHIPPED',
      createdAt: new Date('2026-07-06T09:15:00Z'),
      zaloUserId: 'user-1',
      paymentMethod: 'COD',
      voucherCode: 'WELCOME10',
      discountAmount: 6.50 * 25000,
