...
export class MetaDto {
  @ApiProperty({
    example: '73292a8d-48c9-4545-932b-299c0952c320',
    description: 'Unique request identifier',
  })
  request_id: string;

  @ApiProperty({
    example: 'bea56618-05d7-4aa9-bd77-6e23bf0e7c36',
    description: 'Trace ID for monitoring',
  })
  trace_id: string;
}
...
export class ErrorDetailDto {
  ...
  @ApiProperty({
    example: 'email',
    description: 'Target field containing error',
  })
  field: string;
...
export class ErrorResponseDto {
  @ApiProperty({
    ...
    description: 'General error summary',
  })
  message: string;
